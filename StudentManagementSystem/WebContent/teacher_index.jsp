...
<body class="easyui-layout">
	...
	<div data-options="region:'north'"
		style="height:85px;background-image:url(images/bg1.jpg);background-size:100% 100%">
	...
	<div data-options="region:'west',title:'菜单',split:true" style="width:255px;">
		...
		<div id="menu" class="easyui-accordion" style="width:250px;height:255px;">
			...
			<div title="老师身份" data-options="selected:true" style="overflow:auto;padding:10px;">
				<ul class="easyui-tree">

					<li data-options="attributes:{'href':'teacher-releaseCourse'}">发布课程</li>


					<li data-options="attributes:{'href':'teacher-enteringGrades'}">录入成绩</li>

					<li data-options="attributes:{'href':'teacher-updatepass'}">修改密码</li>
