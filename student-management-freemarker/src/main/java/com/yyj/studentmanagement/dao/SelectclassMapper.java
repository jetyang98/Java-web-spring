...
public interface SelectclassMapper {
	...
	@Select("insert into selectclass (class_id, student_id, class_score)\r\n" + 
			"    values (#{class_id}, #{student_id},null)")
	void Studentselect(Selectclass selectclass) ;
	
	
	@Select("select  class.class_id  ,  class.class_name  , class.teacher_id , teacher.teacher_name  ,class.class_address , class.class_time ,selectclass.class_score\r\n" + 
			"	FROM selectclass\r\n" + 
			"	LEFT JOIN	 class ON selectclass.class_id=class.class_id \r\n" + 
			"	LEFT JOIN  teacher ON  teacher.teacher_id=class.teacher_id\r\n" + 
			"	where  selectclass.student_id=#{student_id};")
	...
	@Select(" select  class.class_id  ,  class.class_name  , selectclass.student_id , student_name  , selectclass.class_score\r\n" + 
			"		FROM teacher\r\n" + 
