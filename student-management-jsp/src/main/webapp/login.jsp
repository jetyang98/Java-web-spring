...
<head>
	...
	<script type="text/javascript" src="/static/js/jquery-easyui-1.5/jquery.min.js"></script>
	...
	<script src="/static/js/angular-1.2.0/angular.min.js"></script>
		...
		<div class="col-md-4 col-sm-4 col-xs-4" style="border: 3px solid #A2D2EE; padding: 50px; border-radius: 15px">
			...
			<div class="page-header">
				...
				<h1 style="word-break: keep-all; white-space: nowrap; color: #FFFFFF">
					<i> <img src='/static/images/logo.png' style="width: 50px;" />
					</i>学生管理系统
				</h1>
			</div>
